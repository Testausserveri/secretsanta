...
var Subscribers = (function () {
    ...
    Subscribers.prototype.get = function (subscriberId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.http.get("/subscribers/" + subscriberId)];
                    case 1: return [2, _a.sent()];
                }
            });
        });
    ...
    Subscribers.prototype.update = function (subscriberId, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.http.put("/" + subscriberId + "/subscribers", __assign({}, data))];
                    case 1: return [2, _a.sent()];
                }
            });
        });
    ...
    Subscribers.prototype.getPreference = function (subscriberId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.http.get("/subscribers/" + subscriberId + "/preferences")];
                    case 1: return [2, _a.sent()];
                }
            });
        });
    ...
    Subscribers.prototype.updatePreference = function (subscriberId, templateId, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.http.patch("/subscribers/" + subscriberId + "/preferences/" + templateId, __assign({}, data))];
                    case 1: return [2, _a.sent()];
                }
            });
        });
    ...
    Subscribers.prototype.setCredentials = function (subscriberId, providerId, credentials) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.http.put("/subscribers/" + subscriberId + "/credentials", {
    ...
    Subscribers.prototype.delete = function (subscriberId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.http.delete("/subscribers/" + subscriberId)];
                    case 1: return [2, _a.sent()];
                }
            });
        });
